...
nj_cleaner = NJCleaner(
    "C:\\Users\\PlacidoScardone\\source\\repos\\spideyboy18\\BEVADAT2022232\\HAZI\\HAZI06\\2018_03.csv")
nj_cleaner.prep_df(
    "C:\\Users\\PlacidoScardone\\source\\repos\\spideyboy18\\BEVADAT2022232\\HAZI\\HAZI06\\NJ.csv")

good_solution = pd.read_csv(
    "C:\\Users\\PlacidoScardone\\source\\repos\\spideyboy18\\BEVADAT2022232\\HAZI\\HAZI06\\NJ_60k.csv")
print(good_solution)
actual_solution = pd.read_csv(
    "C:\\Users\\PlacidoScardone\\source\\repos\\spideyboy18\\BEVADAT2022232\\HAZI\\HAZI06\\NJ.csv")
print(actual_solution)
passed = actual_solution.head(60000).equals(good_solution)
print("passed" if passed else "not passed")

# Split the dataset into input features and target variable
X = actual_solution.iloc[:, :-1].values
Y = actual_solution.iloc[:, -1].values.reshape(-1, 1)

# Split the dataset into training and test sets
X_train, X_test, Y_train, Y_test = train_test_split(
    X, Y, test_size=0.2, random_state=41)

# Try different hyperparameter values to find the best combination
start = time.time()

classifier = DecisionTreeClassifier(min_samples_split=45, max_depth=7)
classifier.fit(X_train, Y_train)
Y_pred = classifier.predict(X_test)
best_accuracy = accuracy_score(Y_test, Y_pred)

# best_accuracy = 0
# for min_samples_split in [45, 55, 100, 200, 20000]:
#     for max_depth in [7]:
...
#         print("Best hyperparameters: min_samples_split =",
...
# print("Best hyperparameters: min_samples_split =",
#       best_min_samples_split, "max_depth =", best_max_depth)
print("Accuracy:", best_accuracy)
print("Training time:", end - start, "seconds")

"""
4.
Próbálkoztam a grid searching módszerrel. Hamar rájöttem, hogy 7 feletti mélység errort eredményez, de mégis el kellett mennem a falig, mert akkor kaptam a legjobb eredményeket.
A sample split növelése pedig nem feltétlen növelte a hatékonyságot.
# Best hyperparameters: min_samples_split = 10 max_depth = 3
# Accuracy: 0.7839166666666667
# Best hyperparameters: min_samples_split = 10 max_depth = 5
# Accuracy: 0.7885833333333333
# Best hyperparameters: min_samples_split = 10 max_depth = 7
# Accuracy: 0.7935
# Best hyperparameters: min_samples_split = 25 max_depth = 3
# Accuracy: 0.7839166666666667
# Best hyperparameters: min_samples_split = 25 max_depth = 5
# Accuracy: 0.7885833333333333
# Best hyperparameters: min_samples_split = 25 max_depth = 7
# Accuracy: 0.7936666666666666
# Best hyperparameters: min_samples_split = 35 max_depth = 3
# Accuracy: 0.7839166666666667
# Best hyperparameters: min_samples_split = 35 max_depth = 5
# Accuracy: 0.7885833333333333
# Best hyperparameters: min_samples_split = 35 max_depth = 7
# Accuracy: 0.7935833333333333
# Best hyperparameters: min_samples_split = 45 max_depth = 7
# Accuracy: 0.7935
